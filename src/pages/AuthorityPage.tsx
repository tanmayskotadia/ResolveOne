    ...
    <div className="min-h-screen bg-slate-50">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-slate-400 text-xs">Municipal Corporation</span>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 pb-12">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 bg-white rounded-xl shadow-card border border-slate-100">
            <div className="w-12 h-12 bg-red-50 text-danger rounded-full flex items-center justify-center mb-4">
          ...
          <div className="space-y-6">
            {/* View Toggle */}
            <Card noPadding className="p-2 inline-flex bg-white shadow-sm border border-slate-200">
              <button
                onClick={() => setViewMode('list')}
                className={['px-4 py-1.5 text-sm font-medium rounded-lg transition-colors flex items-center gap-2', viewMode === 'list' ? 'bg-slate-100 text-slate-800' : 'text-slate-500 hover:text-slate-700'].join(' ')}
              >
              ...
              <button
                ...
                className={['px-4 py-1.5 text-sm font-medium rounded-lg transition-colors flex items-center gap-2', viewMode === 'map' ? 'bg-slate-100 text-slate-800' : 'text-slate-500 hover:text-slate-700'].join(' ')}
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
