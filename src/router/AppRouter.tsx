 ...
 *   /citizen/verify      → Aadhaar Verification (public)
 *   /citizen/report      → Report Issue (requires CitizenContext hash)
 *   /citizen/track       → Track Complaint (public)
 *   /authority/login     → Authority Login (public)
            ...
            <div className="flex flex-col min-h-screen">
              ...
              <main className="flex-1">
                <Routes>
                  ...
                  {/* /citizen redirects directly to verify — no dashboard */}
